...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Используем следующие тест-кейсы:
		      \begin{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item В процессе тестирования оказалось, что в Rellume плохая поддержка RISC-V-хоста
		      \begin{itemize}
			      \item Некоторые тест-кейсы используют MCJIT, которые падают с SEGFAULT на RISC-V
		      \end{itemize}
		\item Хотим попробовать обновить версию LLVM до 19, что потенциально может решить проблему
		      \begin{itemize}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Есть два варианта решения этой проблемы:
		      \begin{itemize}
			      \item с помощью self-hosted runner на RISC-V
